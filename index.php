...
<!--<![endif]-->
    ...
    <body class="night">
        ...
        <footer>
                <h3 lang="ja"><?= date("Y"); ?> <a href="http://danielgamage.com/">Daniel Gamagea</a></h3>
        ...
        <script>
          ...
          ga('create', 'UA-49061997-2', 'danielgamage.com');
          ga('send', 'pageview');
        </script>
    </body>
</html>
